  ...
  return (
    <div className="relative flex flex-col gap-2 py-12 overflow-hidden bg-transparent">
      ...
      <Marquee className="[--duration:30s] [--gap:0rem]" repeat={10}>
        <span className="text-3xl md:text-5xl lg:text-6xl font-extrabold uppercase tracking-tighter text-[#3B82F6] whitespace-nowrap px-8" style={{ fontFamily: 'var(--font-syne), sans-serif' }}>
          Let&apos;s Grow Together
        </span>
      </Marquee>
